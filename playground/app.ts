...
container.innerHTML = `
  ...
  <div style="width:100px;height:100px;resize:both;overflow:hidden;"><x-plot autoresize width="200" height="60" background="#066" color="yellow" zoom="20" line-width="6"></x-plot></div>
`
...
const plots = container.querySelectorAll('x-plot') as NodeListOf<PlotElement>
const rate = 44100
...
plots[0].data = Array(44100)
  .fill(0)
  .map((_, i) => sine(i, 1))
plots[1].data = Array(44100)
  .fill(0)
  .map((_, i) => sine(i, 10))
plots[2].data = Array(44100)
  .fill(0)
  .map((_, i) => sine(i, 100))
plots[4].data = Array(44100)
  .fill(0)
  .map((_, i) => sine(i, 100))
